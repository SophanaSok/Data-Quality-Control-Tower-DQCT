...
function saveSettings(nextSettings) {
  ...
  window.dispatchEvent(new CustomEvent("dqct:settings-changed", { detail: normalized }));
  return normalized;
}
...
function saveRecentRuns(runs) {
  ...
  window.dispatchEvent(new CustomEvent("dqct:runs-changed", { detail: normalized }));
  return normalized;
}

function addHistoryRun(entry) {
